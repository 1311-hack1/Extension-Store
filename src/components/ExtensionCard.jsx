    ...
    <div className="flex flex-row p-3 border border-gray-200 rounded-lg gap-3 hover:shadow-md transition-shadow w-full">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex flex-wrap items-center gap-2 mt-1">
          <span className="text-sm text-gray-500">By {extension.author}</span>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="flex-1 text-gray-600 hover:text-gray-800 px-4 py-2 rounded text-sm font-medium border border-gray-200 hover:border-gray-300 transition-colors"
          >
            View Source
          </button>
        </div>
